<?php
class api_model_tipocom{



		//-------- Tabla Tipo comprobante de pago       --------
		//--------------------------------------------------	
    ...
    public function tipocom_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/buscar/'.$p_codigo;
    ...
    public function tipocom_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/borrar/'.$p_codigo;
    ...
    public function tipocom_editar($p_info_json){

  
        $p_codigo = $p_info_json['tipocomprobante_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/editar/'.$p_codigo;
    ...
    public function tipocom_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/registrar';
    ...
    public function tipocom_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/listar';
    ...
    public function tipocom_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipocom/listar_descripcion/'.$p_campo_dato;
