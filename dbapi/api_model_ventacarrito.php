...
class api_model_ventacarrito{
    ...
    public function ventacarrito_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/buscar/'.$p_codigo;
    ...
    public function ventacarrito_buscar_ultimaventa($p_cliente){

  
	
        $datojson = json_encode("");

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/buscar_ultimaventa/'.$p_cliente;
    ...
    public function ventacarrito_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/borrar/'.$p_codigo;
    ...
    public function ventacarrito_editar($p_info_json){

        $p_codigo = $p_info_json['venta_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/editar/'.$p_codigo;
    ...
    public function ventacarrito_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/registrar';
    ...
    public function ventacarrito_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/listar';
    ...
    public function ventacarrito_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/ventacarrito/listar_descripcion/'.$p_campo_dato;
