...
class api_model_proveedor{
    ...
    public function proveedor_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/buscar/'.$p_codigo;
    ...
    public function proveedor_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/borrar/'.$p_codigo;
    ...
    public function proveedor_editar($p_info_json){

  
        $p_codigo = $p_info_json['proveedor_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/editar/'.$p_codigo;
    ...
    public function proveedor_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/registrar';
    ...
    public function proveedor_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/listar';
    ...
    public function proveedor_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/listar_descripcion/'.$p_campo_dato;
    ...
    public function proveedor_listar_pordni($p_campo_dni){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/proveedor/listar_dni/'.$p_campo_dni;
