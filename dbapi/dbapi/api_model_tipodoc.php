...
class api_model_tipodoc{
    ...
    public function tipodoc_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/buscar/'.$p_codigo;
    ...
    public function tipodoc_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/borrar/'.$p_codigo;
    ...
    public function tipodoc_editar($p_info_json){

  
        $p_codigo = $p_info_json['tipodocumento_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/editar/'.$p_codigo;
    ...
    public function tipodoc_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/registrar';
    ...
    public function tipodoc_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/listar';
    ...
    public function tipodoc_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/tipodoc/listar_descripcion/'.$p_campo_dato;
