...
<?php 
class api_model_ventadetallecarrito{
    ...
    public function ventadetallecarrito_buscar($p_codigo){

  
	
        $datojson = json_encode("");

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/buscar/'.$p_codigo;
    ...
    public function compradetallecarrito_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/borrar/'.$p_codigo;
    ...
    public function compradetallecarrito_editar($p_info_json){

  
        $p_codigo = $p_info_json['compradetallecarrito_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/editar/'.$p_codigo;
    ...
    public function compradetallecarrito_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/registrar';
    ...
    public function compradetallecarrito_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/listar';
    ...
    public function compradetallecarrito_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compradetallecarrito/listar_descripcion/'.$p_campo_dato;
