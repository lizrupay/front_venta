...
class api_model_compra{
    ...
    public function compra_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compra/buscar/'.$p_codigo;
    ...
    public function compra_editar($p_info_json){

  
        $p_codigo = $p_info_json['compra_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compra/editar/'.$p_codigo;
    ...
    public function compra_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compra/registrar';
    ...
    public function compra_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compra/listar';
    ...
    public function compra_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/compra/listar_descripcion/'.$p_campo_dato;
