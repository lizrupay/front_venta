...
class api_model_usuario{
    ...
    public function usuario_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/buscar/'.$p_codigo;
    ...
    public function usuario_validarlogin($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/validarlogin';
    ...
    public function usuario_editar($p_info_json){

  
        $p_codigo = $p_info_json['usuario_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/editar/'.$p_codigo;
    ...
    public function usuario_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/registrar';
    ...
    public function usuario_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/listar';
    ...
    public function usuario_listar_pordescripcion($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/usuario/listar_descripcion/'.$p_campo_dato;
