...
class api_model_cliente_login{
    ...
    public function cliente_buscar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/buscar/'.$p_codigo;
    ...
    public function cliente_eliminar($p_codigo){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/borrar/'.$p_codigo;
    ...
    public function cliente_editar($p_info_json){

  
        $p_codigo = $p_info_json['cliente_id'];
        $datojson = json_encode($p_info_json);

        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/editar/'.$p_codigo;
    ...
    public function cliente_registrar($p_info_json){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/registrar';
    ...
    public function cliente_listar(){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/listar';
    ...
    public function cliente_listar_porid($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/listar_id/'.$p_campo_dato;
    ...
    public function cliente_listar_pornombre($p_campo_dato){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/listar_nombre/'.$p_campo_dato;
    ...
    public function cliente_listar_porapellido($p_campo_dni){

  
	
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/listar_apellido/'.$p_campo_dni;
    ...
    public function cliente_listar_pordni($p_campo_dni){
        ...
        $rludato = 'http://172.96.143.27:8085/proyecto/tecnomarket/cliente/listar_dni/'.$p_campo_dni;
